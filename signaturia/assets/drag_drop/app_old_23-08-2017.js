...
function _init() {
   ...
   //$(".htmlpage, .htmlpage .column").sortable({connectWith: ".column", opacity: .35, handle: ".drag"});
    $("#structure .lyrow").draggable({connectToSortable: ".htmlpage", helper: "clone", handle: ".drag", drag: function (e, t) {
            t.helper.width(400)
        }, stop: function (e, t) {
...
function downloadLayoutSrc() {
    ...
    // html2canvas($('#src'), {
            onrendered: function (canvas) {
                ...
                data:{'signature_id': $('#signature_id').val(),'html' : $(".htmlpage").html(),'email_html' : $(".formated_html").html(),'image_data':imagedata},
