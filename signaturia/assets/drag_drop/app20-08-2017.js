...
var el = $( '<p contenteditable="true">I\'m editable!</p>' );
    ...
    //jQuery('.lyrow').find('.ckContainer').find('p').focus();
    ...
    switch (type) {
        ...
        */
        case 'paragraph':
            ...
            $(document).on('keyup change','.row_padding_center, .row-margin-center, .cell_padding_center, .cell-margin-center, #row_colbg, #cell_colbg, .row_colorselectorbg, .cell_colorselectorbg, #rowbgimage',function(){
                $(confirm).trigger('click');
            });
        ...
        case 'image':
            ...
            $(document).on('keyup change','.row_padding_center, .row-margin-center, .cell_padding_center, .cell-margin-center, #row_colbg, #cell_colbg, .row_colorselectorbg, .cell_colorselectorbg, #rowbgimage, #img-url, #img-width, #img-height, #img-rel',function(){
                $(confirm).trigger('click');
            });
