...
function _init() {
    ...
    $(window).resize(function () {
        ...
        //$(".htmlpage").css("min-height", $(window).height() - 280);
    });
    ...
    $(".htmlpage, .htmlpage .column").sortable({
        ...
        if(ui.item[0].dataset.type == 'paragraph'){
         ...
         if(el = element.find('p')){
            ...
            }else if(ui.item[0].dataset.type == 'twitter'){
                var user_id = $('#user_id').val();
                $.ajax({
            url: "dashboard/check_twitter",
            success: function (result) {
                if (result == 1) {
                    //$('#latest_tweet_val').val(1);
                    $.ajax({
                        url: "twitter/get_latest_tweet?id="+user_id,
                        success: function (result) {
                            $('.latest_tweet').html(result);
                        }
                    });
                    //$('.remove_tweet_btn').show();
                    //$('.get_tweet_btn').hide();
                } else {
                    $('.twitter_modal').modal();
                }
...
//     });
    ...
    $(".download_generator").click(function (e) {
        var signature_type = $(this).attr('data-type');
        downloadGeneratorLayoutSrc(signature_type);
    });
...
function loadRowSettings(row) {
    ...
    $('#signature_font_style').val(row.css('font-family')).change();
    // image
...
function saveRowSettings(row) {
    ...
    row.css('font-family',$('#signature_font_style').val());
    // image
    ...
    switch (type) {
        ...
        */
        case 'paragraph':
            ...
            if($('#section_'+section_id).length > 0){
                LoadUserSettings(section_id);
            }else{
                AssignDefaultSettingValue();
            }
            ...
            $(document).on('keyup change','.row_padding_center, .main_cell-margin-center, .main_cell_padding_center, .row-margin-center, .cell_padding_center, .cell-margin-center, .row_colbg, .cell_colbg, .row_colorselectorbg, .cell_colorselectorbg, #rowbgimage, #signature_font_style',function(){
                $(confirm).trigger('click');
            });
            ...
            confirm.bind('click', function (e) {
                ...
                $('#'+section_id).find('.ckContainer').find('p').css('border-radius',$('.main_border_radious').val());
                $('#'+section_id).find('.ckContainer').find('p').css('background',$('.main_backround_color').val());

                // $('.internal_settings').append('<input type="hidden" id="section_'+section_id+'" data_mainline_height= "'+line_height+'" data_mainletter_spacing= "'+letter_spacing+'" data_align_main= "'+content_aling+'" data_border_style= "'+$('.border_style').val()+'" data_border_size= "'+$('.border_size').val()+'" data_border_color= "'+$('.border_color').val()+'" data_main_border_radious = "'+$('.main_border_radious').val()+'" data_main_margin_top = "'+$('.margin_top').val()+'" data_main_margin_right = "'+$('.margin_right').val()+'" data_main_margin_bottom = "'+$('.margin_bottom').val()+'" data_main_margin_left = "'+$('.margin_left').val()+'"F data_main_padding_top = "'+$('.padding_top').val()+'" data_main_padding_right = "'+$('.padding_right').val()+'" data_main_padding_bottom = "'+$('.padding_bottom').val()+'" data_main_padding_left = "'+$('.padding_left').val()+'" data_main_backround_color = "'+$('.main_backround_color').val()+'">');

                StoreUserSettings(section_id,line_height,letter_spacing,content_aling,style_css,vertical_align_css);
        ...
        case 'image':
           ...
           $('#img-width').val(img.innerWidth());
            ...
            $(document).on('keyup change','.row_padding_center, .main_cell-margin-center, .main_cell_padding_center, .row-margin-center, .cell_padding_center, .cell-margin-center, .row_colbg, .cell_colbg, .row_colorselectorbg, .cell_colorselectorbg, #rowbgimage, #img-url, #img-width, #img-height, #img-rel, #img-url-link, #signature_font_style',function(){
                $(confirm).trigger('click');
            });
            ...
            confirm.bind('click', function (e) {
                ...
                $('#'+section_id).find('.view').find('img').css('border-radius',$('.main_border_radious').val());
                $('#'+section_id).find('.view').find('img').css('background',$('.main_backround_color').val());

                StoreUserSettings(section_id,"","","",style_css,vertical_align_css);
        ...
        case 'youtube' :
            ...
            $(document).on('keyup change','.row_padding_center, .main_cell-margin-center, .main_cell_padding_center, .row-margin-center, .cell_padding_center, .cell-margin-center, .row_colbg, .cell_colbg, .row_colorselectorbg, .cell_colorselectorbg, #rowbgimage, #img-url, #img-width, #img-height, #img-rel, #img-url-link, #video-url, #video-width, #video-height',function(){
                $(confirm).trigger('click');
            });
            $(document).on('load','img',function(){
                $(confirm).trigger('click');
            ...
            confirm.bind('click', function (e) {
                ...
                $('#'+section_id).find('.view').find('iframe').css('margin-top', $('.margin_top').val());
                $('#'+section_id).find('.view').find('iframe').css('margin-left', $('.margin_left').val());
                $('#'+section_id).find('.view').find('iframe').css('margin-right', $('.margin_right').val());
                $('#'+section_id).find('.view').find('iframe').css('margin-bottom', $('.margin_bottom').val());
                
                $('#'+section_id).find('.view').find('iframe').css('padding-top', $('.padding_top').val());
                $('#'+section_id).find('.view').find('iframe').css('padding-left', $('.padding_left').val());
                $('#'+section_id).find('.view').find('iframe').css('padding-right', $('.padding_right').val());
                $('#'+section_id).find('.view').find('iframe').css('padding-bottom', $('.padding_bottom').val());

                $('#'+section_id).find('.view').find('iframe').css('border',border_style_css);
                $('#'+section_id).find('.view').find('iframe').css('border-radius',border_radious_css);
                $('#'+section_id).find('.view').find('iframe').css('background',background_css);
        ...
        case 'twitter':
            ...
            confirm.bind('click', function (e) {
                ...
                $('#'+section_id).find('.ckContainer').css('padding',padding_css);
                $('#'+section_id).parent().parent().css('vertical-align',vertical_align_css);
                $('#'+section_id).find('p').css('line-height',line_height);
                $('#'+section_id).find('p').css('letter-spacing',letter_spacing);
                $('#'+section_id).find('p').css('text-align',content_aling);
                
                $('#'+section_id).find('p').css('margin-top', $('.margin_top').val());
                $('#'+section_id).find('p').css('margin-left', $('.margin_left').val());
                $('#'+section_id).find('p').css('margin-right', $('.margin_right').val());
                $('#'+section_id).find('p').css('margin-bottom', $('.margin_bottom').val());
                
                $('#'+section_id).find('p').css('padding-top', $('.padding_top').val());
                $('#'+section_id).find('p').css('padding-left', $('.padding_left').val());
                $('#'+section_id).find('.ckContainer').find('p').css('padding-right', $('.padding_right').val());
                $('#'+section_id).find('p').css('padding-bottom', $('.padding_bottom').val());

                $('#'+section_id).find('p').css('border',border_style_css);
                $('#'+section_id).find('p').css('border-radius',$('.main_border_radious').val());
                $('#'+section_id).find('p').css('background',$('.main_backround_color').val());
        ...
        case 'button' :
            ...
            $(document).on('keyup change','#buttonLabel, #buttonHref, #custombtnwidth, #custombtnheight, #custombtnfont, #custombtnpaddingtop, #colbtn, #colbtncol, #colorselectorbtn, #colorselectorbtncol, #signature_font_style',function(){
                $(confirm).trigger('click');
            });
            $(document).on('change','.border_style',function(){
                border = $(this).val();
            ...
            confirm.bind('click', function (e) {
                ...
                $('#'+section_id).find('.view .button_tag').css('border-radius',$('.main_border_radious').val());
                $('#'+section_id).find('.view .button_tag').css('background',$('.main_backround_color').val());

                StoreUserSettings(section_id);
            });
...
//            });
            ...
            confirm.bind('click', function (e) {
                ...
                StoreUserSettings(section_id,"","","",align_style_css,vertical_align_css);
        ...
        case 'social' :
            ...
            $(document).on('keyup change','.row_padding_center, .main_cell-margin-center, .main_cell_padding_center, .row-margin-center, .cell_padding_center, .cell-margin-center, .row_colbg, .cell_colbg, .row_colorselectorbg, .cell_colorselectorbg, #rowbgimage, .social_media_style, #signature_font_style',function(){
                $(confirm).trigger('click');
            });
            $(document).on('change','.border_style',function(){
                border = $(this).val();
            ...
            confirm.bind('click', function (e) {
                ...
                $('#'+section_id).find('.social_wrapper .social_icons_wrap').css('border-radius',$('.main_border_radious').val());
                $('#'+section_id).find('.social_wrapper .social_icons_wrap').css('background',$('.main_backround_color').val());
        ...
        case 'appstore' :
            ...
            $(document).on('keyup change','.row_padding_center, .main_cell-margin-center, .main_cell_padding_center, .row-margin-center, .cell_padding_center, .cell-margin-center, .row_colbg, .cell_colbg, .row_colorselectorbg, .cell_colorselectorbg, #rowbgimage, .app_store_style, #signature_font_style',function(){
                $(confirm).trigger('click');
            });
            $(document).on('change','.border_style',function(){
                border = $(this).val();
            ...
            confirm.bind('click', function (e) {
                ...
                $('#'+section_id).find('.view').find('.media_content_wrapper').css('border-radius',$('.main_border_radious').val());
                $('#'+section_id).find('.view').find('.media_content_wrapper').css('background',$('.main_backround_color').val());
...
function AssignDefaultSettingValue(){

        // Settings Tab
        $('.border_style').val("").change();
        $('.border_size').val('0px');
        $('.border_color').val("");
        $('.main_border_radious').val("0px");

        $('.main_cell-margin-center').val("0px");
        $('.main_cell_padding_center').val("0px");        
        $('.main_backround_color').val("");

        $('.media_set').val("icon1");
        $('.media_size').val("40px").change();

        $('.devider_style').val("solid");
        $('.devider_height').val("1px");
        $('.devider_width').val("1px");
        $('.devider_color').val("");

        // Call Settings
        $('.cell_colbg').val("rgba(0, 0, 0, 0)");
        $('.cell_padding_center').val('0px');

        // Row Settings
        $('.row_colbg').val("rgba(0, 0, 0, 0)");
        $('#signature_font_style').val("Helvetica, Arial, sans-serif").change();
        $('.rowbgimage').val('none');
        $('.row_padding_center').val('0px');
}

function StoreUserSettings(section_id,line_height,letter_spacing,content_aling,style_css,vertical_align_css){
    if($('#section_'+section_id).length > 0){
        $('#section_'+section_id).remove();
    }
    $('.internal_settings').append('<input type="hidden" id="section_'+section_id+'"  data_mainline_height= "'+line_height+'" data_mainletter_spacing= "'+letter_spacing+'" data_align_main= "'+content_aling+'" data_border_style= "'+$('.border_style').val()+'" data_border_size= "'+$('.border_size').val()+'" data_border_color= "'+$('.border_color').val()+'"  data_main_border_radious = "'+$('.main_border_radious').val()+'" data_main_margin_top = "'+$('.margin_top').val()+'" data_main_margin_right = "'+$('.margin_right').val()+'" data_main_margin_bottom = "'+$('.margin_bottom').val()+'" data_main_margin_left = "'+$('.margin_left').val()+'" data_main_padding_top = "'+$('.padding_top').val()+'" data_main_padding_right = "'+$('.padding_right').val()+'" data_main_padding_bottom = "'+$('.padding_bottom').val()+'" data_main_padding_left = "'+$('.padding_left').val()+'" data_main_backround_color = "'+$('.main_backround_color').val()+'" data_main_media_set = "'+$('.media_set').val()+'" data_main_media_size = "'+$('.media_size').val()+'" data_main_devider_style = "'+$('.devider_style').val()+'" data_main_devider_height = "'+$('.devider_height').val()+'" data_main_devider_width = "'+$('.devider_width').val()+'" data_main_devider_color = "'+$('.devider_color').val()+'" data_cell_colbg = "'+$('.cell_colbg').val()+'" data_cell_align = "'+style_css+'" data_cell_vertical_align = "'+vertical_align_css+'" data_cell_padding_top = "'+$('.cell_padding_top').val()+'" data_cell_padding_right = "'+$('.cell_padding_right').val()+'" data_cell_padding_bottom = "'+$('.cell_padding_bottom').val()+'" data_cell_padding_left = "'+$('.cell_padding_left').val()+'" data_row_padding_top = "'+$('.row_padding_top').val()+'" data_row_padding_right = "'+$('.row_padding_right').val()+'" data_row_padding_bottom = "'+$('.row_padding_bottom').val()+'" data_row_padding_left = "'+$('.row_padding_left').val()+'" data_row_colbg = "'+$('.row_colbg').val()+'" data_row_fontfamily = "'+$('#signature_font_style').val()+'" data_row_rowbgimage = "'+$('#rowbgimage').val()+'">');
}

function LoadUserSettings(section_id){
    console.log(section_id);
        $('.border_style').val($('#section_'+section_id).attr('data_border_style')).change();
        $('.border_size').val($('#section_'+section_id).attr('data_border_size'));
        $('.border_color').val($('#section_'+section_id).attr('data_border_color'));
        $('.main_border_radious').val($('#section_'+section_id).attr('data_main_border_radious'));

        $('.margin_top').val($('#section_'+section_id).attr('data_main_margin_top'));
        $('.margin_right').val($('#section_'+section_id).attr('data_main_margin_right'));
        $('.margin_bottom').val($('#section_'+section_id).attr('data_main_margin_bottom'));
        $('.margin_left').val($('#section_'+section_id).attr('data_main_margin_left'));

        $('.padding_top').val($('#section_'+section_id).attr('data_main_padding_top'));
        $('.padding_right').val($('#section_'+section_id).attr('data_main_padding_right'));
        $('.padding_bottom').val($('#section_'+section_id).attr('data_main_margin_bottom'));
        $('.padding_left').val($('#section_'+section_id).attr('data_main_margin_left'));



        $('.main_backround_color').val($('#section_'+section_id).attr('data_main_backround_color'));

        $('.media_set').val($('#section_'+section_id).attr('data_main_media_set'));
        $('.media_size').val($('#section_'+section_id).attr('data_main_media_size')).change();

        $('.devider_style').val($('#section_'+section_id).attr('data_main_devider_style'));
        $('.devider_height').val($('#section_'+section_id).attr('data_main_devider_height'));
        $('.devider_width').val($('#section_'+section_id).attr('data_main_devider_width'));
        $('.devider_color').val($('#section_'+section_id).attr('data_main_devider_color'));

        // Call Settings
        $('.cell_colbg').val($('#section_'+section_id).attr('data_cell_colbg'));
        $('.cell_padding_top').val($('#section_'+section_id).attr('data_cell_padding_top'));
        $('.cell_padding_right').val($('#section_'+section_id).attr('data_cell_padding_right'));
        $('.cell_padding_bottom').val($('#section_'+section_id).attr('data_cell_padding_bottom'));
        $('.cell_padding_left').val($('#section_'+section_id).attr('data_cell_padding_left'));


        // Row Settings
        $('.row_colbg ').val($('#section_'+section_id).attr('data_row_colbg'));
        if($('#section_'+section_id).attr('data_row_rowbgimage') == ''){
            $('.rowbgimage').val('none');    
        }else{
            $('.rowbgimage').val($('#section_'+section_id).attr('data_row_rowbgimage'));    
        }
        $('#signature_font_style').val($('#section_'+section_id).attr('data_row_fontfamily')).change();

        $('.row_padding_top').val($('#section_'+section_id).attr('data_row_padding_top'));
        $('.row_padding_right').val($('#section_'+section_id).attr('data_row_padding_right'));
        $('.row_padding_bottom').val($('#section_'+section_id).attr('data_row_padding_bottom'));
        $('.row_padding_left').val($('#section_'+section_id).attr('data_row_padding_left'));
}
    ...
    // html2canvas($('#src'), {
            onrendered: function (canvas) {
                ...
                success: function(result){
                   ...
                   }else if(signature_type == 'generator'){
                        var g_id = $('#generator_id').val();
                        if(g_id != ''){
                            window.location = 'generators/edit_generator/'+g_id+'/'+result; 
                        }else{
                            window.location = 'generators/create_generator/'+result;     
                        }
...
function downloadGeneratorLayoutSrc(signature_type) {
    //  var e = "";
    $('.loading').show();  
    $("#download-layout").children().html($(".htmlpage").html());
    // var t = $("#download-layout").children();
    ...
    // html2canvas($('#src'), {
            onrendered: function (canvas) {
                ...
                type: "POST",
                url: "SaveCustomSignature",
                data:{'signature_type':signature_type,'signature_id': '','html' : $(".htmlpage").html(),'email_html' : $(".formated_html").html(),'image_data':imagedata},
                success: function(result){
                   $('.formated_html').html('');
                   $('#auto_download').attr('href',$('#base_url').val()+'user/dashboard/download_custom/'+result);
