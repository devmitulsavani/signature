        ...
        */
        ...
        case 'horizontal' :
            ...
            confirm.bind('click', function (e) {
                ...
                $('#'+section_id).find('.horizontal_wrapper hr').css('border-top',style_css);
                $('#'+section_id).find('.horizontal_wrapper hr').css('width',width_style_css);
                $('#'+section_id).find('.view').css('padding',padding_css);
                $('#'+section_id).parent().parent().css('vertical-align',vertical_align_css);
        ...
        case 'vertical' :
            var align_style_css = '';
            var style_css = 'border-left: 1px solid #ccc;';
            var padding_css = '';
            var vertical_align_css = '';
            var btn = part.find('.vertical_wrapper > div');
            btn_id = btn.assignId();
            var clone = btn.clone();
            var width_style_css = '';
            ...
            $('.line_height_space').hide();
            $('#horizontaldevider').hide();
            $('#verticaldevider').show();
            $(document).on('click','.css_align',function(){
                align_style_css = $(this).attr('data-align');
                $(confirm).trigger('click');
            });
            $(document).on('change','.vertical_devider_style',function(){
                border = $(this).val();
                d_hight = $('#vertical_devider_width').val();
                d_color = $('#vertical_devider_color').val();
                style_css = d_hight+ " " + border + d_color;
                $(confirm).trigger('click');
            });
            $(document).on('keyup change','.vertical_devider_width',function(){
                border = $('.vertical_devider_style').val();
                d_hight = $('#vertical_devider_width').val();
                d_color = $('#vertical_devider_color').val();
                style_css = d_hight+ " " + border + d_color;
                $(confirm).trigger('click');
            });
            $(document).on('keyup change','.vertical_devider_color',function(){
                d_color = $(this).val();
                border = $('.vertical_devider_style').val();
                d_hight = $('#vertical_devider_width').val();
                style_css = d_hight+ " " + border + d_color;
            ...
            confirm.bind('click', function (e) {
                ...
                o.attr('id', $('#id').val());
                $('#'+section_id).parent().parent().css('text-align',align_style_css);
                $('#'+section_id).parent().parent().css('border-left',style_css);
                $('#'+section_id).parent().parent().css('width',width_style_css);
                $('#'+section_id).parent().parent().css('width',width_style_css);

                // $('#'+section_id).parent().parent().css('width',width_style_css);
                // $('#'+section_id).find('.vertical_wrapper').css('border-left',style_css);
                // $('#'+section_id).find('.vertical_wrapper').css('width',width_style_css);
                $('#'+section_id).find('.view').css('padding',padding_css);
                $('#'+section_id).parent().parent().css('vertical-align',vertical_align_css);
                
                $('#'+section_id).find('.view').find('.vr_devider').css('margin-top', $('.margin_top').val());
                $('#'+section_id).find('.view').find('.vr_devider').css('margin-left', $('.margin_left').val());
                $('#'+section_id).find('.view').find('.vr_devider').css('margin-right', $('.margin_right').val());
                $('#'+section_id).find('.view').find('.vr_devider').css('margin-bottom', $('.margin_bottom').val());
                
                $('#'+section_id).find('.view').find('.vr_devider').css('padding-top', $('.padding_top').val());
                $('#'+section_id).find('.view').find('.vr_devider').css('padding-left', $('.padding_left').val());
                $('#'+section_id).find('.view').find('.vr_devider').css('padding-right', $('.padding_right').val());
                $('#'+section_id).find('.view').find('.vr_devider').css('padding-bottom', $('.padding_bottom').val());
            });
