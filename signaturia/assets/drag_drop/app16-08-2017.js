                                    ...
                                    request.done(function(msg) {
                                        ...
                                        for(var i = 0; i<msg.length; i++){
                                            if(jQuery.inArray(msg[i]['name'], selected_media) !== -1){
                                                $('#'+btn_id+msg[i]['name']).attr('src','uploads/social_icons/'+icon_set+'/'+msg[i][icon]);
                                            }
                                            all_html += '<img src="uploads/social_icons/'+icon_set+'/'+msg[i][icon]+'" id="'+msg[i]['name']+'" data-name="'+msg[i]['name']+'" style="width:35px;margin:5px;" class="custom_social_media '+btn_id+'">';
                                        }
