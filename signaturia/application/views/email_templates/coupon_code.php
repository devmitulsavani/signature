...
<div style="padding:30px;margin:0; display: block;vertical-align:top; text-align:left;">
    ...
    background-color: #bdceb2;">
        <strong>Use coupon : <?php echo $coupon_code ?></strong>
    </p>
    <p style="padding:0; margin:0; color:#000; font-size:14px; font-weight:400; font-family:Arial, Helvetica, sans-serif; line-height:22px;margin-bottom:20px;">
        Your coupon is valid from <b><?php echo $from_date ?></b> to <b><?php echo $to_date ?></b>
    </p>
    <p style="padding:0; margin:0; color:#000; font-size:14px; font-weight:400; font-family:Arial, Helvetica, sans-serif; line-height:22px;margin-bottom:20px;">
        <a href="<?php echo $button_link; ?>" style="font-size: 14px;color: #fff;background: #44980c;border: none;padding: 15px 25px;font-weight: 500;line-height: 16px;display: inline-block;border-radius: 3px;min-width: 230px;text-transform: uppercase;text-align: center;letter-spacing: 1px;text-decoration:none;">Upgrade now</a>
    </p><br><br><br>
