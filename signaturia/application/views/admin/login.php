                            ...
                            <div class="panel panel-body login-form">
                                <div class="text-center">
                                    <div class="icon-object border-slate-300 text-slate-300">
                                        ...
                                        <img src="assets/images/logo-icn.png" width="50" />
                                        <!-- <i class="icon-user text-muted"></i> -->
                                    </div>
                                    <h5 class="content-group">Welcome to Signaturia Admin<small class="display-block">Login to your account</small></h5>
                                </div>
                                <?php
