...
.custom-wrap .custom-tools {height: calc(100vh - 71px);position: fixed;left: 60px;top: 71px;width: 250px;background: #eee;border-right: solid 1px #ddd;padding: 15px;}
.custom-tools::-webkit-scrollbar {display:none}
.custom-wrap .custom-dash {height: calc(100vh - 71px);margin-left: 250px;}
.custom * {-webkit-transition: all 0s ease;-o-transition: all 0s ease;transition: all 0s ease;}

.custom-tools .sidebar-nav{}
            ...
            <li class="rows" id="estRows">
              <div class="lyrow"> <a href="#close" class="remove btn btn-danger btn-xs"><i class="glyphicon-remove glyphicon"></i></a> <a class="drag btn btn-default btn-xs"><i class="glyphicon glyphicon-move"></i></a> <a href="#" class="btn btn-info btn-xs clone"><i class="fa fa-clone"></i></a>
                ...
                <div class="view">
                  <table width="100%">
                    <tr>
                      <td class="row clearfix col-md-12"><div class="column"></div></td>
                    </tr>
                  </table>
                </div>
              </div>
              <div class="lyrow"> <a href="#close" class="remove btn btn-danger btn-xs"><i class="glyphicon-remove glyphicon"></i></a> <a class="drag btn btn-default btn-xs"><i class="glyphicon glyphicon-move"></i></a> <a href="#" class="btn btn-info btn-xs clone"><i class="fa fa-clone"></i></a>
                ...
                <div class="view">
                  <table width="100%">
                    <tr >
                      <td class="row clearfix col-md-6"><div class="column"></div></td>
                      <td class="row clearfix col-md-6"><div class="column"></div></td>
                    </tr>
                  </table>
                </div>
              ...
              <div class="lyrow"> <a href="#close" class="remove btn btn-danger btn-xs"><i class="glyphicon-remove glyphicon"></i></a> <a class="drag btn btn-default btn-xs"><i class="glyphicon glyphicon-move"></i></a> <a href="#" class="btn btn-info btn-xs clone"><i class="fa fa-clone"></i></a>
                ...
                <div class="view">
                  <table width="100%">
                    <tr>
                      <td class="row clearfix col-md-8"><div class=" column"></div></td>
                      <td class="row clearfix col-md-4"><div class=" column"></div></td>
                    </tr>
                  </table>
                  <br>
                </div>
              ...
              <div class="lyrow"> <a href="#close" class="remove btn btn-danger btn-xs"><i class="glyphicon-remove glyphicon"></i></a> <a class="drag btn btn-default btn-xs"><i class="glyphicon glyphicon-move"></i></a> <a href="#" class="btn btn-info btn-xs clone"><i class="fa fa-clone"></i></a>
                ...
                <div class="view">
                  <table width="100%">
                    <tr>
                      <td class="row clearfix col-md-3"><div class=" column"></div></td>
                      <td class="row clearfix col-md-9"><div class=" column"></div></td>
                    </tr>
                  </table>
                  <br>
                </div>
