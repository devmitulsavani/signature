...
.dash-wrap .custom-tools .nav-tabs li{margin: 0 0 -1px;width: 50%;}
.dash-wrap .custom-tools .nav-tabs li a{text-align: center;padding: 0 14px;border: none;line-height: 50px;background: #ddd;color: #333;border-left:solid 1px #ccc;border-bottom:solid 1px #ccc;}
.dash-wrap .custom-tools .nav-tabs li a .fa{margin-right: 5px;}
.dash-wrap .custom-tools .nav-tabs li.active a, .dash-wrap .custom-tools .nav-tabs li.active a:focus, .dash-wrap .custom-tools .nav-tabs li.active a:hover{background: #eee;border-top: none;border-bottom:solid 1px #eee;border-left:solid 1px #ccc;color: #52b51b;}
.dash-wrap .custom-tools .nav-tabs li:first-child a, .dash-wrap .custom-tools .nav-tabs li:first-child.active a, .dash-wrap .custom-tools .nav-tabs li:first-child.active a:focus, .dash-wrap .custom-tools .nav-tabs li:first-child.active a:hover{border-left:none;}
.dash-wrap .custom-tools .tab-pane{padding:14px;}

.custom-wrap .custom-dash {height: calc(100vh - 71px);margin-left: 350px;padding: 15px 0;}
              ...
              <div class="tools-row">
                <div class="tools-box">
                  <div class="box box-element" data-type="paragraph"><a href="#close" class="remove btn btn-danger btn-xs"><i class="glyphicon glyphicon-remove"></i></a><a class="drag btn btn-default btn-xs"><i class="glyphicon glyphicon-move"></i></a><span class="configuration"><a class="btn btn-xs btn-warning settings"  href="#" ><i class="fa fa-gear"></i></a></span>
                    ...
                    <div class="view"><p>Click me to edit</p></div>
                  </div>
                </div>
                <div class="tools-box">
