...
<!--                <div class="tools-box">
              ...
              <div class="tools-box">
                  <div class="box box-element" data-type="horizontal"><a href="#close" class="remove btn btn-danger btn-xs"><i class="glyphicon glyphicon-remove"></i></a><a class="drag btn btn-default btn-xs"><i class="glyphicon glyphicon-move"></i></a><span class="configuration"> <a class="btn btn-xs btn-warning settings" href="#" ><i class="fa fa-gear"></i></a></span>
                    ...
                    <div class="view horizontal_wrapper"> <hr class='hr_devider' style="border-top: 1px solid #ccc;margin:20px 0;padding:0;"></hr> </div>
                  </div>
                </div>
                <!-- <div class="tools-box">
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="Settings">
                  ...
                  <div id="appstore" style="display:none">
                    <div class="set-title"><h4>Set App Store Link</h4></div>
                    <div class="set-box">
...
//                      });
      ...
      //                      });
                    ...
                    <div class="set-title non_code_control"><h4>Margin</h4></div>
                    <div class="set-box non_code_control">
                      <div class="row four-box">
                        <div class="col-xs-6">
                          <div class="form-group">
                    ...
                    <div class="set-title non_code_control"><h4>Padding</h4></div>
                    <div class="set-box non_code_control">
                      <div class="row four-box">
                        <div class="col-xs-6">
                          <div class="form-group">
            ...
            <li>
              <div class="btn-group" data-toggle="buttons-radio">
                ...
                <?php if($custom_generator == 1){?>
                  <button type="button" id="save" class="btn btn-warning float-right save_signature" data-type="generator"><i class="fa fa-save"></i>&nbsp;Next</button>
                <?php } elseif($share_generator == 1){ ?>
                  <button type="button" id="save" class="btn btn-warning float-right download_generator" data-type="download-generator"><i class="fa fa-save"></i>&nbsp;Download</button>
                <?php }else { ?>
              ...
              <div class="lyrow">
                <!-- <a href="#close" class="remove btn btn-danger btn-xs"><i class="glyphicon-remove glyphicon"></i></a><a class="drag btn btn-default btn-xs"><i class="glyphicon glyphicon-move"></i></a><a href="#" class="btn btn-info btn-xs clone"><i class="fa fa-clone"></i></a> -->
                  ...
                  <div class="view">
                    <table width="100%">
                      <tr>
                        <td class="row" style="width:100%;"><div class="column art-board"></div></td>
                      </tr>
                    </table>
                  </div>
                </div>
